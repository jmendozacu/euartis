	...
	extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareMassaction()
	{
		...
		$this->getMassactionBlock()->addItem('status', array(
			 ...
			 'url'  => $this->getUrl('*/adminhtml_fields/massStatus', array('webform_id' => $this->getParam('id'))),
			 'additional' => array(
					'visibility' => array(
						 'name' => 'status',
						 'type' => 'select',
		...
		if(count($fieldsetsOptions)>1) {
			$this->getMassactionBlock()->addItem('fieldset', array(
				 ...
				 'url'  => $this->getUrl('*/adminhtml_fields/massFieldset', array('webform_id' => $this->getParam('id'))),
				 'additional' => array(
						'visibility' => array(
							 'name' => 'fieldset',
							 'type' => 'select',
