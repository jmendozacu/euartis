 ...
 */
class Magestore_Showroom_Block_Catalog_Product_List extends Magestore_Showroom_Block_Catalog_Product_Abstract
{
    const TEMPLATE_PATH_CONTAINER = "showroom/showroom/container.phtml";
    ...
    public function getToolbarBlock() 
    {
        ...
        if (!$this->_helper()->checkVersion('1.4.0.0')){
            return $this->getLayout()->createBlock('showroom/catalog_product_list_toolbar');            
        }
        # Endfix
                
        if ($this->getParentBlock() &&
                ($this->getParentBlock() instanceof Magestore_Showroom_Block_Catalog_Product_Container)
                ){
