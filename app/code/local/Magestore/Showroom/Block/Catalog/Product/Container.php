 ...
 */
class Magestore_Showroom_Block_Catalog_Product_Container extends Magestore_Showroom_Block_Catalog_Product_Abstract
{
     ...
     * Loader Template
     */
    const TEMPLATE_PATH_LOADER = "showroom/showroom/container/loader.phtml";
    ...
    {
		//Zend_Debug::dump(parent::getToolbarHtml());
